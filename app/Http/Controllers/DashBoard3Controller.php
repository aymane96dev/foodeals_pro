...
class DashBoard3Controller extends Controller
{
    ...
    public function getintprixfirst()
    {
        $mons = DB::table('commandes')
            ->join('clients','clients.id','=','commandes.clients_id')
            ->select(DB::raw(" EXTRACT(MONTH FROM commandes.created_at) as month"))
        ...
        $intprix = DB::table('produits')
            ...
            ->select(DB::raw('sum(produits.qte) as products'),'produits.prix')
            ->where(DB::raw('EXTRACT(MONTH FROM produits.created_at)'),$months[0]['month'])
   ...
   /* public function getmodalitefirst(){
        ...
        $modalites_place = DB::table('detailcommandes')
            ...
            ->where(DB::raw('EXTRACT(MONTH FROM commandes.created_at)'),$months[0]['month'])
        ...
        $modalites = [$modalites_place,$modalites_emporter];
