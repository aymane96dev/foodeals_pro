   ...
   <div class="container">
       ...
       <div class="row justify-content-end mt-5 mb-2">
                   ...
                   <div class="form-group">
                       <select onchange="month()" class="form-control bg-info text-white" id="months">
                           @foreach($mons as $month)
                               <option value="{{ $month->month }}"><span class="text-white" ><?php $month_name = date("F", mktime(0, 0, 0, $month->month, 10)); echo $month_name; ?></span></option>
                           @endforeach
                       </select>
                   </div>
               </div>
           ...
           <div class="col-3">
               <div class="dropdown bootstrap-select float-right">
                   <div class="form-group">
                       <select onchange="city()" class="form-control bg-info text-white" id="citys">
                           @foreach($cities as $city)
                               <option value="{{$city->id}}"><span class="text-white" >{{ $city->nom }}</span></option>
                           @endforeach
                       </select>
                   </div>
               </div>
        ...
        <div class="row justify-content-start mt-3">
            ...
            <div class="col-3">
                <div class="card card-inverse card-warning">
                    ...
                    <div class="box text-center">
                        <h1 class="font-light text-white"><span>{{ $users }}</span>&nbsp;&nbsp;&nbsp;<i class="fas fa-address-card"></i></h1>
